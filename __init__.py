...
DEVELOPER_KEY = "AIzaSyBRkgwICWaPBA5L_ef5-c92ylV6yg8HEqA"
...
# Reddit API Key
reddit = praw.Reddit(client_id="dQRVlr-saEDo9Q",
                     client_secret="d6nIadFNaTda6j3R9UXJkfNcg7M",
...
def teams(teamid):
    ...
    current_season_info = team_season_info[0];
